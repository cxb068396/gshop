...
Page({
  ...
  data: {
    ...
    pwd_val: '', // 密码值
    imgsrc:'../../static/icon/circular.png',
    imgsrctwo:'../../static/icon/circularcolor.png'
  ...
  onqiehuan:function(){
    if (this.data.imgsrc=="../../static/icon/circular.png"){    
      this.setData({
        imgsrc: "../../static/icon/circularcolor.png"
      })  
      }else{
        this.setData({
          imgsrc: "../../static/icon/circular.png"
